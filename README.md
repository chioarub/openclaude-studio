...
- Optional session replay timeline with structured execution steps, tool breakdowns, retry tracking, and redacted summaries (requires a newer OpenClaude version that produces replay sidecar files)
...
- [x] Session replay timeline with structured steps, tool breakdowns, retry tracking, and redacted summaries (when replay sidecars are available)
